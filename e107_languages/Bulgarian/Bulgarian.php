...
define("LAN_REQUIRED", "Задължително");
define("LAN_DEVELOPERMODE_CHECK", "[b]Понастоящем режимът за програмисти е активиран. Използвайте този режим само при разработване![/b][br]Моля, деактивирайте режима за програмисти, когато използвате уебсайта си в живо производство. Когато режимът за програмисти е активиран, поверителна информация може да се показва на обществеността!");
