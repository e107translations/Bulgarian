...
define("LAN_DEVELOPERMODE_CHECK", "[b]Режимът за разработка в момента е активиран. Използвайте този режим само при разработка![/b] [br]Моля, деактивирайте режима за разработка, когато използвате уебсайта си в режим официално. Когато режимът за разработка е активиран, конфиденциална информация може да се види публично!");
