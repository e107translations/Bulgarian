 ...
 *
 * $Id: lan_user_extended.php 948 2014-01-20 12:14:34Z veskoto $
 * $URL: http://dev.clabteam.com/svn/e107bg/main/langpack/e107_0.8/e107_languages/Bulgarian/lan_user_extended.php $
 * $Revision: 948 $
 * $Author: veskoto $
*/
...
define("UE_LAN_LOCATION_DESC", "Местонахождение на потребителя");
...
define("UE_LAN_TIMEZONE", "Часова зона");
define("UE_LAN_TIMEZONE_DESC", "Потребителска часова зона ( от предварително зададен списък )");
define("LAN_UE_FAIL_HOMEPAGE", "Невалидна стойност за настройка на начална страница");
define("UE_LAN_SKYPE", "Skype");
define("UE_LAN_SKYPE_DESC", "Skype потребител");
