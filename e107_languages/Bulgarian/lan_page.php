...
define("LAN_PAGE_14", "Други статии");
define("LAN_PAGE_15", "Статии");
define("LAN_PAGE_16", "Няма под-категории в тази категория");
define("LAN_PAGE_17", "Коментарите на тази страница са заключени.");
