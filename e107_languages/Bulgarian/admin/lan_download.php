...
define("DOWLAN_160", "Спри едновременно сваляне от индивидуални потребители");
define("DOWLAN_161", "Използвайте рекламна страница, за да забавите изтеглянето на файлове");
define("DOWLAN_162", "Свалено от");
define("DOWLAN_163", "Потребител");
define("DOWLAN_164", "IP");
define("DOWLAN_165", "Дата / Час");
define("DOWLAN_166", "Обратно към всички Файлове");

// v1.0.3
define("DOWLAN_199", "Внимание: след изчистването на статистиката за всеки файл може и да не се отрази на общата статистика!");
define("DOWLAN_200", "Number");
define("DOWLAN_201", "Изчисти лога");
define("DOWLAN_202", "Детайли по изчистването на лога");