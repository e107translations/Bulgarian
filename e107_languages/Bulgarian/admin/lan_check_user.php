 ...
 *
 * $Id: lan_check_user.php 916 2014-04-11 06:05:50Z nickypn $
 * $URL: http://dev.clabteam.com/svn/e107bg/main/langpack/e107_0.8/e107_languages/Bulgarian/admin/lan_check_user.php $
 * $Revision: 916 $
 * $Author: nickypn $
*/
define('LAN_CKUSER_01','Проверка в базата данни на потребителите');
define('LAN_CKUSER_02','Това ще провери за възможни пробмени във Вашата база данни на потребителите');
...
define('LAN_CKUSER_13','Намерени са доблирани имейли');
define('LAN_CKUSER_14','Имейл');
define('LAN_CKUSER_15','Не са намерени са доблирани имейли');
define('LAN_CKUSER_16','Намери потребители които съвпадат с името за логване на някой друг потребител');
define('LAN_CKUSER_17','Конфликт при име за логване и име за покзване');
define('LAN_CKUSER_18','Потребител 1');
define('LAN_CKUSER_19','Потребител 2');
