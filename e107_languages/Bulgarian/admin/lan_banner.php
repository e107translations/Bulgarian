 ...
 *
 * $Id: lan_banner.php 916 2012-04-11 06:05:50Z nickypn $
 * $URL: http://dev.clabteam.com/svn/e107bg/main/langpack/e107_0.8/e107_languages/Bulgarian/admin/lan_banner.php $
 * $Revision: 916 $
 * $Author: nickypn $
*/
...
define("BNRLAN_25", "Изберете съществуваща");
define("BNRLAN_26", "Въведете нова");
define("BNRLAN_27", "Клиент");
define("BNRLAN_28", "изберете съществуващ");
define("BNRLAN_29", "въведете нов");
define("BNRLAN_30", "Име за вход на клиента");
...
define("BNRLAN_43", "Изберете картинка за банер");
define("BNRLAN_45", "Стартиране");
define("BNRLAN_46", "Код");
define("BNRLAN_58", "Начало");
define("BNRLAN_59", "Нов банер");
define("BNRLAN_60", "кампании");
define("BNRLAN_61", "Меню Банери ");
define("BNRLAN_62", "Настройка на банери");
...
define("BANNER_MENU_L6", "Кампания за показване в менюто");
...
define("BANNER_MENU_L19", "Брой банери за показване:<br />използва се само, когато е избрана повече от една кампания");