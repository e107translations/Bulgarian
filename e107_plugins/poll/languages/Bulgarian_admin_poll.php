...
define("POLLAN_32", "Натисни тук за да видиш резултатите");
...
define("POLLAN_38", "до");
define("POLLAN_39", "Благодаря Ви за гласуването!");
define("POLLAN_40", "Натиснете тук за да видите резултатите");
define("POLLAN_41", "Тази анкета е предназначена само за потребители");
