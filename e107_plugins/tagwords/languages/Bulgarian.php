 ...
 *
*/
define("LAN_TAG_INS_1", "Тагове");
define("LAN_TAG_INS_2", "A fully featured Tagword system");
define("LAN_TAG_INS_3", "Настройка на модул Тагове");
...
define("LAN_TAG_SEARCH_1", "Търсене заr:");
define("LAN_TAG_SEARCH_2", "Търси");
define("LAN_TAG_SEARCH_3", "Виж");
define("LAN_TAG_1", "Тагове");
define("LAN_TAG_2", "Таг");
define("LAN_TAG_3", "Модул Тагове е обновен");
define("LAN_TAG_4", "подредба");
define("LAN_TAG_5", "показване");
define("LAN_TAG_6", "");
define("LAN_TAG_7", "< Обратно");
define("LAN_TAG_8", "резултат намерен за");
define("LAN_TAG_9", "резултати намерени за");
define("LAN_TAG_10", "по азбучен ред");
define("LAN_TAG_11", "по големина");
define("LAN_TAG_12", "списък с тагове");
define("LAN_TAG_13", "tagcloud");
define("LAN_TAG_14", "избор:");
define("LAN_TAG_15", "всички области");
