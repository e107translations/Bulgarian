 ...
 * $URL: http://dev.clabteam.com/svn/e107bg/main/langpack/e107_0.8/e107_plugins/clock_menu/languages/Bulgarian.php $
 * $Revision: 917 $
 * $Author: nickypn $
*/
define('CLOCK_MENU_L1', 'Настройките на менюто са запазени');
define('CLOCK_MENU_L2', 'Заглавие');
define('CLOCK_MENU_L3', 'Обновяване на настройките');
define('CLOCK_MENU_L4', 'Настройки на меню Чсовник');
