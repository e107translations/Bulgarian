...
define("LAN_AL_PM_ADM_11", "Лични съобщения: съхранените прикачени файлове не могат да бъдат защитени от директно изтегляне");
define("LAN_AL_PM_ADM_12", "Лични съобщения: прикаченият файл е отказан, защото директорията му не може да бъде защитена от директно изтегляне");
