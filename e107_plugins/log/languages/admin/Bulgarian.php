...
define("ADSTAT_L35", "Виж компактна информация за браузърите в статистиката");
define("ADSTAT_L38", "Трябва да дадете права за писане на директорията e107_plugins/log/logs");